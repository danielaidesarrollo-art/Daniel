...
import { Wallet, Fuel, Activity, Eye, Play } from 'lucide-react'
      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center p-4">
        <div className={`glass-card max-w-4xl w-full transition-all duration-700 ${isListening ? 'border-emerald-500/30' : 'border-white/10'}`}>
          <header className="space-y-6 mb-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`transition-all duration-300 ${isListening ? 'scale-110' : 'scale-100'}`}>
                  <NeuralLogo size={48} animated={isListening} />
                </div>
                <h1 className="text-2xl font-bold tracking-tight">
                  Daniel <span className="text-slate-500 font-normal">Core</span>
                </h1>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-flow-cyan/20">
            ...
            <div className="p-1 rounded-2xl bg-black/40 border border-flow-cyan/10 shadow-inner">
              <div className="flex items-center gap-3 px-4 py-3 bg-white/5 rounded-xl border border-flow-cyan/20 focus-within:border-flow-cyan/50 focus-within:ring-1 focus-within:ring-flow-cyan/50 focus-within:flow-glow-cyan transition-all duration-300">
                <div className="text-flow-cyan">
                  <Wallet size={18} />
                </div>
                <div className="flex-1 flex flex-col">
                  ...
                  <input
                    ...
                    className="bg-transparent border-none outline-none text-sm font-mono text-flow-cyan placeholder:text-slate-600 w-full"
                  />
                </div>
                <div className="px-2 py-1 rounded text-[10px] font-bold bg-flow-emerald/10 text-flow-emerald border border-flow-emerald/20 uppercase">
